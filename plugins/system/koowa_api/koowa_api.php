...
class plgSystemKoowa_Api extends JPlugin{
	...
	{ 
		require_once dirname(__FILE__).'/behaviors/executable.php';
		require_once dirname(__FILE__).'/exceptions/exception.php';
		require_once dirname(__FILE__).'/views/json.php';

		if(!KRequest::get('get.api_key','string')) return;
		
		$api = KService::get('com://admin/api.model.api')
					->set('key', KRequest::get('get.api_key','string'))
					->set('token',KRequest::get('get.api_token','raw'));
